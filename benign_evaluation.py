...
if __name__ == "__main__":
    ...
    filename = f"benign_evaluation-{args.target_model}.json"
    if args.test:
        os.environ["TESTING"] = "true"
        filename = f"benign_evaluation_test-{args.target_model}.json"

    dataset = main()
    print(f"saving to: {str(DATA_DIR / "interim" / filename)}")
