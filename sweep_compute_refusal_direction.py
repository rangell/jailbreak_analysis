...
singularity exec --nv\
            --overlay /scratch/rca9780/jailbreaks/overlay-15GB-500K-nnsight.ext3:ro \
            /scratch/work/public/singularity/cuda12.3.2-cudnn9.0.0-ubuntu-22.04.4.sif /bin/bash \
            -c 'source /ext3/env.sh; python -u compute_refusal_direction.py --model_name __model_name__'\
"""
