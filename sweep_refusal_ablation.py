...
singularity exec --nv\
            ...
            -c 'source /ext3/env.sh; python -u compute_refusal_ablation.py --target-model __model_name__ --evaluated-responses data/interim/evals___model_name__.json'\
"""
...
if __name__ == "__main__":
    ...
    for model_name in models:
        ...
        out_path = "{}/refusal_ablation-{}".format(base_output_dir, model_name)
