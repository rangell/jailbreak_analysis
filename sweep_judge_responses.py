...
singularity exec --nv\
            --overlay /scratch/rca9780/jailbreaks/overlay-15GB-500K-strongreject.ext3:ro \
            /scratch/work/public/singularity/cuda12.3.2-cudnn9.0.0-ubuntu-22.04.4.sif /bin/bash \
            -c 'source /ext3/env.sh; python -u judge_jailbreak_responses.py --model-name __model_name__ --responses-dir __responses_dir__'\
"""
...
if __name__ == "__main__":
    ...
    responses_dir = "/scratch/rca9780/jailbreak_analysis_data/jailbreak_responses/jailbreak_success/"
